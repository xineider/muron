...
router.get('/adicionar/filtro', function(req, res, next) {
	res.render(req.isAjaxRequest() == true ? 'api' : 'montadorMobile', {html: 'postagens/postagens_filtro', data: data, usuario: req.session.usuario});
});

router.get('/adicionar/filtro/faculdades', function(req, res, next) {
	res.render(req.isAjaxRequest() == true ? 'api' : 'montadorMobile', {html: 'postagens/postagens_filtro_faculdades', data: data, usuario: req.session.usuario});
});
