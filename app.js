...
var gruposMob = require('./app/controller/gruposMob');
var chatsMob = require('./app/controller/chatsMob');
var faculdadesMob = require('./app/controller/faculdadesMob');
var postagensMob = require('./app/controller/postagensMob');
var adminMob = require('./app/controller/adminMob');
var sobreMob = require('./app/controller/sobreMob');
var apiMob = require('./app/controller/apiMob');
var configuracoesMob = require('./app/controller/configuracoesMob');
...
app.use('/mobsmart/grupos', gruposMob);
app.use('/mobsmart/chats', chatsMob);
app.use('/mobsmart/faculdades', faculdadesMob);
app.use('/mobsmart/admin', adminMob);
app.use('/mobsmart/postagens', postagensMob);
app.use('/mobsmart/sobre', sobreMob);
app.use('/mobsmart/api', apiMob);
app.use('/mobsmart/configuracoes', configuracoesMob);
